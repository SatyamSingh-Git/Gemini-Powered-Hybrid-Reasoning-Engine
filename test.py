# src/reasoning_engine/core/agent.py (FINAL, BUG-FIXED, TESTED)
...
class ReasoningAgent:
    def __init__(self, retriever: HybridRetriever):
        ...
        self.query_gen_model = genai.GenerativeModel('gemini-1.5-flash')
    ...
    def _execute_tool_call(self, tool_call, chunks) -> List[Dict[str, Any]]:
        ...
        if tool_name in AVAILABLE_TOOLS:
            ...
            try: return tool_function(**tool_args)
            except Exception as e: return [{"error": f"Error executing tool: {e}"}]
    ...
    async def answer_question(self, query: str) -> Answer:
        ...
        synthesis_prompt = f"""
                ...
                - If the evidence seems incomplete, synthesize what you can and note what is missing.
        ...
        return Answer(query=query, decision="Information Found", payout=None, justification=[], simple_answer=final_answer_text)
